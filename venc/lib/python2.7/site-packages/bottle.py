...
class Bottle(object):
    ...
    def wsgi(self, environ, start_response):
        ...
        try:
            ...
            print('in bottle wsgi interface====')
            print(out)
            print('===============')
            return out
        except (KeyboardInterrupt, SystemExit, MemoryError):
...
def run(app=None, server='wsgiref', host='127.0.0.1', port=8080,
    ...
    if reloader and not os.environ.get('BOTTLE_CHILD'): # main进程在env中添加了BOTTLE_CHILD,因此子进程不会在执行这个if下的代码
        print('parrent proc load here %d'%os.getpid())
        try:
            lockfile = None
            ...
            while os.path.exists(lockfile):
                ...
                print('====')
                print('parrent proc %d'%(os.getpid()))
                print('args:'+str(args))
...
class FileCheckerThread(threading.Thread):
        ...
        while not self.status:
            ...
            for path, lmtime in list(files.items()):
                if not exists(path) or mtime(path) > lmtime:
                    print(str(self.getName()) + '\tfile modified')
                    self.status = 'reload'
                    thread.interrupt_main()
                    print(str(self.getName()) + '\tinterrupt here')
                    break
    ...
    def __exit__(self, exc_type, exc_val, exc_tb):
        ...
        self.join()
        print(str(self.getName()) + '\tin exit join called')
